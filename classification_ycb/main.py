...
def main():
    ...
    if not os.path.isfile(os.path.join(args.checkpoint, "last_checkpoint.pth")):
        save_args(args)
        logger = Logger(os.path.join(args.checkpoint, 'log.txt'), title="YCB" + args.model)
        ...
        logger = Logger(os.path.join(args.checkpoint, 'log.txt'), title="YCB" + args.model, resume=True)
        optimizer_dict = checkpoint['optimizer']

    printf('==> Preparing data..')
    train_loader = DataLoader(YCB(partition='train', num_points=args.num_points), num_workers=args.workers,
                              batch_size=args.batch_size, shuffle=True, drop_last=True)
    test_loader = DataLoader(YCB(partition='test', num_points=args.num_points), num_workers=args.workers,
